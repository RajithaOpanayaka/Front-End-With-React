...
import {Navbar, NavbarBrand,Nav,NavbarToggler,Collapse,
    NavItem,Jumbotron,Button,Modal,ModalHeader,ModalBody, FormGroup,Form,Input,Label} from 'reactstrap';
             ...
             <Navbar dark expand="md">
                 <div className="container">
                     ...
                     <NavbarBrand className="mr-auto" href="/">
                         <img src="assets/images/logo.png" height="30" width="41" alt="Hotel"/>
                     </NavbarBrand>
                     ...
                     <Nav className='ml-auto' navbar>
                         <NavItem>
                             <Button outline onClick={this.toggleModel}>
                                 <span className="fa fa-sign-n fa-lg"></span>Login
                             </Button>
                         </NavItem>
                     </Nav>
                     </Collapse>
              ...
              <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModel}>
                  ...
                  <ModalBody>
                      <Form onSubmit={this.handleLogin}>
                          ...
                          <FormGroup check>
                              <Label check>
                                  <Input type="checkbox" name="remember" innerRef={(input)=>this.remeber=input}/>
                                  Remember me
                              </Label>
                          </FormGroup>
